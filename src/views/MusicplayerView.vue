<template>
    <div class="relative h-[100vh] transition-container">
      <div class="absolute z-[3]">
        ...
        <div class="relative top-[10%] w-[100vw] h-[120vw]">
          ...
          >
            <img src="/static/yuan.png" alt="" class="w-[80vw] h-[80vw]" />
            <img
        ...
        <div class="fixed bottom-0">
          ...
          <div class="w-[100vw] flex justify-evenly items-center">
            ...
            />
            <Icon icon="iconoir:emoji-sing-right-note" color="white" width="25" />
